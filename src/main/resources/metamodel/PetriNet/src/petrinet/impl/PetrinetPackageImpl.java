...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPlace_InitialMarking(), ecorePackage.getEInt(), "initialMarking", "0", 0, 1, Place.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (arcEClass,
		   source,
		   new String[] {
			   "ArcTypeConstraint", "((self.source.oclIsTypeOf(Place)) implies (self.target.oclIsTypeOf(Transition))) and ((self.source.oclIsTypeOf(Transition)) implies (self.target.oclIsTypeOf(Place)))"
		   });
	}
